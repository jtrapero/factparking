      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            />
            {/* Contenedor para los botones para asegurar un espaciado y visibilidad correctos */}
            <div className="flex flex-col gap-4 pt-2">
              {" "}
              {/* Añadido pt-2 para un pequeño espacio superior */}
              <Button type="submit" className="w-full">
                Enviar
              </Button>
              <Button
                type="button" // Asegura que no actúe como botón de envío del formulario
                variant="outline"
                className="w-full bg-transparent"
                onClick={() => {
                  console.log("Volver al menú principal - Clicked!")
                  // Aquí puedes añadir la lógica de navegación real, por ejemplo:
                  // router.push('/menu-principal'); // Navega a la ruta '/menu-principal'
                }}
              >
